...
import 'package:ecashier/DatabaseManager/database_manager.dart';
        ...
        builder: (context, snapshot){
          return ListView.builder(
            ...
            itemBuilder: (context, index){
              ...
              return ListTile(
              leading:Image.network (barang['image']),
              title: Text(barang['Nama Barang'],style: TextStyle(fontWeight: FontWeight.bold),),
              dense: true,
